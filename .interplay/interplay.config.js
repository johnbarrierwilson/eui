...
module.exports = () => {
    ...
    return  {
        ...
        packages: [
            {
                name: "@elastic/eui",                            //Name of package to import
                packagePath: "./package.json",      //Path to package.json
                src: "./src/index.ts",                  //Entry file for component parsing
                build: "./dist/eui.js",                //Entry file for component bundling
        ...
        //wrapperComponent: "@scope/example/WrapperComponent",
